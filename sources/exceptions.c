...
extern __declspec(interrupt:0) void EPORT_irq1_handler(void);
extern __declspec(interrupt:0) void EPORT_irq3_handler(void);
extern __declspec(interrupt:0) void EPORT_irq5_handler(void);
extern __declspec(interrupt:0) void EPORT_irq7_handler(void);

extern __declspec(interrupt:0) void PIT1_handler(void);
extern __declspec(interrupt:0) void PIT0_handler(void);
...
__declspec(vectortable) vectorTableEntryType _vect[256] = {   /* Interrupt vector table */
   ...
   EPORT_irq1_handler,           /*  65 (0x104) Device-specific interrupts */
   asm_exception_handler,           /*  66 (0x108) Device-specific interrupts */
   EPORT_irq3_handler,           /*  67 (0x10C) Device-specific interrupts */
   asm_exception_handler,           /*  68 (0x110) Device-specific interrupts */
   EPORT_irq5_handler,           /*  69 (0x114) Device-specific interrupts */
   asm_exception_handler,           /*  70 (0x118) Device-specific interrupts */
   EPORT_irq7_handler,           /*  71 (0x11C) Device-specific interrupts */
   ...
   PIT1_handler,           /* 120 (0x___) Reserved                   */
